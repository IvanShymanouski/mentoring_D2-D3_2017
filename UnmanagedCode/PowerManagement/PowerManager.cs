...
namespace PowerManagement
{
    public class PowerManager
    {
        ...
        public void ManageHibernationFile(bool reserve)
        {
        ...
        private static extern uint CallNtPowerInformation(int informationLevel, IntPtr inputBuffer, uint inputBufferSize, [Out] IntPtr outputBuffer, uint outputBufferSize);
